    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            if (getArguments().getInt(ARG_SECTION_NUMBER) == 1) {
                ...
                RecyclerView NewsRecycler = (RecyclerView) rootView.findViewById(R.id.news_recycler);
                NewsRecycler.setLayoutManager(new LinearLayoutManager(getActivity(), LinearLayoutManager.VERTICAL, true));
                ...
                NewsRecycler.setAdapter(new MyRecyclerAdapter(getActivity(), null));
